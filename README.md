...
Feature Selection 
=================
The dataset itself provided fully feature engineered features, Following are the approach they have done to derive features.
...
After modeling, we made a conclusion that with human-engineered features(561 features) we got almost 96% accuracy. For raw data(without any feature engineering) lstm modeling we almost got 91% accuracy because deep learning models can automatically generate features.

## To Do

* Today we can also use heart rate sensor data.
* Convert this model into an android smart app that can detect activities
